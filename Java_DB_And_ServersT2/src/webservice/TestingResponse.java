...
/**
 *  TestingResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TestingResponse implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"testingResponse".equals(type)) {
                            ...
                            return (TestingResponse) webservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
